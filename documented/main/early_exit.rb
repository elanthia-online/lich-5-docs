...
# Namespace for the Lich script engine.
#
# The Lich engine provides a Ruby interpreter for text-based MUDs,
# including GemStone IV and DragonRealms.
module Lich
  # Namespace for Lich's main entry point and initialization logic.
  module Main
    ...
    module EarlyExit
      # Command-line flags that trigger help output.
      #
      # @see #help?
      # @see #dispatch!
      HELP_FLAGS = ['-h', '--help'].freeze
      HELP_TOPIC_PREFIX = '--help='
      # Command-line flags that trigger version information output.
      #
      # @see #version?
      # @see #dispatch!
