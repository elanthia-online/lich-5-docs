...
# Namespace for the Lich 5 scripting engine, which provides interactive
# scripting capabilities for text-based games GemStone IV and DragonRealms.
module Lich
  # Namespace for shared utilities and common functionality across Lich 5.
  module Common
    # Namespace for GTK graphical user interface components.
    module GUI
