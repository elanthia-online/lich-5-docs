...
module Lich
  # Common game-agnostic models and utilities shared between GemStone IV and DragonRealms scripts.
  module Common
    ...
    module Inventory
      ...
      class Assembly
        ...
        # Initializes a mutable accumulator for assembling a paginated inventory from one or more server responses.
        #
        # @return [void]
        # @api private
        def initialize
