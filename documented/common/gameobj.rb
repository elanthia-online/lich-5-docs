...
# Namespace for the Lich game automation framework.
module Lich
  # Common types and utilities shared across Lich, including the GameObj registry
  # and identity index for tracking all in-game entities.
  module Common
