...
#
# Lich is a Ruby scripting system for the text-based games GemStone IV and
# DragonRealms. Script authors use this module and its submodules to interact
# with the game server and manage their running .lic scripts.
#
# @api public
module Lich
  # Namespace for shared utility modules used across Lich 5.
  #
  # Includes helpers for credential management, logging, data transformation,
