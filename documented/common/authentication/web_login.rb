...
module Lich
  # Namespace for shared functionality across Lich subsystems.
  module Common
    # Namespace for account authentication backends.
    module Authentication
      ...
      module WebLogin
        ...
        class AuthenticationError < StandardError
          ...
          # Initializes the error with a best-effort error code label.
          #
          # @param error_code [String] the error code label (e.g. "LOGIN_FAILED", "CHARACTER_NOT_FOUND")
          # @return [void]
        ...
        # @api private
        class CookieJar
          # Initializes an empty cookie jar for a single authentication session.
          #
          # @return [void]
          def initialize
            @pairs = {}
