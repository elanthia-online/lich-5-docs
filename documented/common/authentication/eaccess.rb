...
module Lich
  ...
  module Common
    # Namespace for Simutronics game server authentication.
    module Authentication
      ...
      module EAccess
        ...
        class AuthenticationError < StandardError
          ...
          # Initializes an authentication error with the server-returned error code.
          #
          # The error code (e.g., "REJECT", "INVALID", "PASSWORD") distinguishes
          # normal credential rejection from unrecognized responses that may indicate
          # backend divergence or relay misconfiguration -- see {EAccess.classify_a_response_failure}.
          #
          # @param error_code [String] server error code from an EAccess protocol response
          # @return [void]
