...
module Lich
  # Namespace for authentication and common utilities.
  module Common
    # Namespace for authentication-related code.
    module Authentication
      ...
      module LaunchResult
        ...
        class MissingLaunchDataError < StandardError
          # Initializes the error with a formatted message listing the missing required keys.
          #
          # @param missing_keys [Array<String>] the keys that are required but absent or blank
          # @return [void]
