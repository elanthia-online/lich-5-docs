...
# Namespace for the Lich scripting engine, supporting text-based games like GemStone IV and DragonRealms.
module Lich
  # Namespace for common utilities and shared functionality across Lich.
  module Common
    # Namespace for authentication, account management, and password handling operations.
