...
# and DragonRealms. This module provides the core runtime and utilities that
# .lic scripts use to interact with the game, manage state, and coordinate
# shutdown and cleanup procedures.
module Lich
  # Namespace for shared utilities and runtime support across Lich 5.
  #
  # The Common module contains shutdown coordination, logging, result handling,
  # and other cross-cutting concerns used by the engine and its scripts.
  module Common
