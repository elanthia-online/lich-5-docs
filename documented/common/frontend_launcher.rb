  ...
  module Common
    ...
    module FrontendLauncher
      SpawnPlan = Struct.new(:environment, :argv, keyword_init: true) do
        ...
        # @param argv [Array<String>] command name and arguments
        # @return [void]
      ...
      # Base error class for frontend launcher failures.
      class Error < StandardError; end
      # Raised when a launcher adapter is not supported on the platform or a frontend
      # lacks a required launcher type.
      class UnsupportedError < Error; end
      # Raised when a required executable, launcher, or frontend installation cannot
      # be located.
