...
#
# Lich is a Ruby scripting engine for text-based games including GemStone IV
# and DragonRealms. This module contains the core engine implementation and
# related authentication and UI infrastructure.
module Lich
  # Common utilities and GUI infrastructure for the Lich engine.
  #
  # This module provides shared functionality including authentication, account
  # management, session launching, and cross-platform GUI components used by
  # the Lich launcher and login systems.
  module Common
