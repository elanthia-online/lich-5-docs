...
# Root namespace for Lich 5, a Ruby scripting engine for text-based games.
module Lich
  # Namespace for Lich utility classes and modules.
  module Util
    ...
    module GtkCompaction
      # @return [String] the C source code marker that indicates the gobject-introspection
      #   native gem carries the GC.compact safety patch for converter pinning.
      # @see .native_gem_patched?
