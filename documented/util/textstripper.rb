...
#
# This module contains the core functionality and utilities for scripting
# in GemStone IV and DragonRealms text-based games.
module Lich
  # Namespace for utility methods and modules used throughout Lich.
  #
  # Contains helper modules like TextStripper for text processing and other
