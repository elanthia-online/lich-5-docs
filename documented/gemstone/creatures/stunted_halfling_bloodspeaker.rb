{
  # Represents a stunted halfling bloodspeaker
  # This entity is a type of humanoid creature with specific attributes and abilities.
  # @example Creating a stunted halfling bloodspeaker
  #   bloodspeaker = { name: "stunted halfling bloodspeaker", level: 103 }
  name: "stunted halfling bloodspeaker",
  noun: "",
  url: "https://gswiki.play.net/Stunted_halfling_bloodspeaker",
  picture: "",
  # The level of the stunted halfling bloodspeaker.
  # @return [Integer] The level of the creature.
  level: 103,
  # The family classification of the stunted halfling bloodspeaker.
  # @return [String] The family type.
  family: "humanoid",
  # The type classification of the stunted halfling bloodspeaker.
  # @return [String] The type of creature.
  type: "biped",
  undead: false,
  boss: false,
  otherclass: [],
  ...
  bcs: true,
  # The maximum hit points of the stunted halfling bloodspeaker.
  # @return [Integer] The maximum health points.
  max_hp: 367,
  speed: nil,
  # The height of the stunted halfling bloodspeaker in feet.
  # @return [Integer] The height of the creature.
  height: 3,
  # The size classification of the stunted halfling bloodspeaker.
  # @return [String] The size of the creature.
  size: "small",
  attack_attributes: {
    # The physical attack attributes of the stunted halfling bloodspeaker.
    # @return [Array<Hash>] List of physical attacks with their attributes.
    physical_attacks: [
      {
        name: "attack",
        as: (420..550)
    ...
    warding_spells: [
      {
        # A warding spell used by the stunted halfling bloodspeaker.
  ...
  defense_attributes: {
    # The armor class of the stunted halfling bloodspeaker.
    # @return [String] The armor class value.
    asg: "2",
    immunities: [],
    # The melee defense range of the stunted halfling bloodspeaker.
    # @return [Range] The range of melee defense.
    melee: (467..502),
    ranged: (521..530),
    bolt: (451..541),
    udf: (542..568),
    ...
    mns_td: (450..461),
    mnm_td: nil,
    # The defensive spells available to the stunted halfling bloodspeaker.
    # @return [Array<Hash>] List of defensive spells with their attributes.
    defensive_spells: [
      {
        name: "prayer (313)"
      },
    ...
    defensive_abilities: [
      {
        # A defensive ability of the stunted halfling bloodspeaker.
  ...
  abilities: [],
  alchemy: [],
  # The treasure attributes of the stunted halfling bloodspeaker.
  # @return [Hash] The treasure details including coins, gems, and other items.
  treasure: {
    coins: true,
    magic_items: nil,
    gems: true,
