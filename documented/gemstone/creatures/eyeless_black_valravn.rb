# Represents an eyeless black valravn
# @example Creating an eyeless black valravn
#   eyeless_black_valravn = { name: "Eyeless black valravn", ... }
{
  # The name of the creature
  # @return [String] The name of the eyeless black valravn
  name: "Eyeless black valravn",
  noun: "",
  # The URL for more information about the creature
  # @return [String] The URL of the eyeless black valravn
  url: "https://gswiki.play.net/Eyeless_black_valravn",
  picture: "",
  # The level of the creature
  # @return [Integer] The level of the eyeless black valravn
  level: 112,
  # The family classification of the creature
  # @return [String] The family of the eyeless black valravn
  family: "Bird",
  # The type classification of the creature
  # @return [String] The type of the eyeless black valravn
  type: "Avian",
  # Indicates if the creature is undead
  # @return [Boolean] True if the eyeless black valravn is undead
  undead: true,
  # Indicates if the creature is a boss
  # @return [Boolean] True if the eyeless black valravn is a boss
  boss: false,
  # Other classifications for the creature
  # @return [Array<String>] Other classes the eyeless black valravn belongs to
  otherclass: [
    "Corporeal undead"
  ],
  # Areas where the creature can be found
  # @return [Array<Hash>] Areas containing the eyeless black valravn
  areas: [
    { name: "Hinterwilds", rooms: [] }
  ],
  # Indicates if the creature has a battle cry
  # @return [Boolean] True if the eyeless black valravn has a battle cry
  bcs: true,
  max_hp: nil,
  speed: nil,
  # The height of the creature in feet
  # @return [Integer] The height of the eyeless black valravn
  height: 5,
  # The size classification of the creature
  # @return [String] The size of the eyeless black valravn
  size: "medium",
  # Attributes related to the creature's attacks
  # @return [Hash] The attack attributes of the eyeless black valravn
  attack_attributes: {
    physical_attacks: [
      {
        name: "",
  ...
  # Attributes related to the creature's defenses
  # @return [Hash] The defense attributes of the eyeless black valravn
  defense_attributes: {
    asg: "1",
    immunities: [],
    melee: nil,
  ...
  abilities: [],
  alchemy: [],
  # Treasure dropped by the creature
  # @return [Hash] The treasure attributes of the eyeless black valravn
  treasure: {
    coins: nil,
    magic_items: nil,
    gems: true,
  ...
  # Messaging related to the creature's actions and characteristics
  # @return [Hash] The messaging attributes of the eyeless black valravn
  messaging: {
