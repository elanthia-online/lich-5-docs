{
  # Represents a brawny gigas shield-maiden
  # @example Creating a brawny gigas shield-maiden
  #   shield_maiden = { name: "brawny gigas shield-maiden" }
  name: "brawny gigas shield-maiden",
  noun: "",
  url: "https://gswiki.play.net/Brawny_gigas_shield-maiden",
  picture: "",
  # The level of the brawny gigas shield-maiden
  # @return [Integer] The level of the shield-maiden
  level: 106,
  # The family type of the brawny gigas shield-maiden
  # @return [String] The family of the shield-maiden
  family: "gigas",
  # The type classification of the brawny gigas shield-maiden
  # @return [String] The type of the shield-maiden
  type: "biped",
  undead: false,
  boss: false,
  otherclass: [],
  ...
  max_hp: nil,
  speed: nil,
  # The height of the brawny gigas shield-maiden in feet
  # @return [Integer] The height of the shield-maiden
  height: 30,
  # The size classification of the brawny gigas shield-maiden
  # @return [String] The size of the shield-maiden
  size: "huge",
  attack_attributes: {
    # The physical attack attributes of the brawny gigas shield-maiden
    # @return [Array<Hash>] The physical attacks available to the shield-maiden
    physical_attacks: [
      {
        name: "shield strike",
        as: (525..566)
    ...
    bolt_spells: [],
    # The warding spells available to the brawny gigas shield-maiden
    # @return [Array<Hash>] The warding spells the shield-maiden can cast
    warding_spells: [
      {
    ...
    offensive_spells: [],
    # The maneuvers available to the brawny gigas shield-maiden
    # @return [Array<Hash>] The maneuvers the shield-maiden can perform
    maneuvers: [
      {
        name: "shield bash",
      },
  ...
  defense_attributes: {
    # The armor class of the brawny gigas shield-maiden
    # @return [String] The armor class of the shield-maiden
    asg: "17",
    immunities: [],
    # The melee defense range of the brawny gigas shield-maiden
    # @return [Range] The melee defense range of the shield-maiden
    melee: (463..695),
    ranged: (383..548),
    bolt: nil,
    udf: nil,
    ...
    mns_td: (396..408),
    mnm_td: nil,
    # The defensive spells available to the brawny gigas shield-maiden
    # @return [Array<Hash>] The defensive spells the shield-maiden can cast
    defensive_spells: [
      {
    ...
    # The defensive abilities of the brawny gigas shield-maiden
    # @return [Array<Hash>] The defensive abilities the shield-maiden possesses
    defensive_abilities: [
      {
  ...
  abilities: [],
  alchemy: [],
  # The treasure attributes of the brawny gigas shield-maiden
  # @return [Hash] The treasure attributes associated with the shield-maiden
  treasure: {
    coins: true,
    magic_items: nil,
    gems: true,
