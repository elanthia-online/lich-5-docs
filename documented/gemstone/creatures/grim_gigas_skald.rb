# Represents a Grim gigas skald creature in the game.
# @example Creating a Grim gigas skald
#   skald = { name: "Grim gigas skald", level: 105 }
{
  ...
  boss: false,
  otherclass: [],
  # List of areas where the Grim gigas skald can be found.
  areas: [
  ...
  height: 28,
  size: "huge",
  # Attributes related to the Grim gigas skald's attacks.
  attack_attributes: {
    physical_attacks: [
      {
        name: "",
  ...
  # Attributes related to the Grim gigas skald's defenses.
  defense_attributes: {
    asg: "6",
    immunities: [],
    melee: (504..690),
  ...
  abilities: [],
  alchemy: [],
  # Treasure attributes associated with the Grim gigas skald.
  treasure: {
    coins: nil,
    magic_items: nil,
    gems: nil,
  ...
  # Messaging attributes for the Grim gigas skald's interactions.
  messaging: {
