{
  # Represents a Behemothic gorefrost golem
  # This entity is a type of golem characterized by its massive size and icy appearance.
  # @example Creating a Behemothic gorefrost golem
  #   golem = BehemothicGorefrostGolem.new
  name: "Behemothic gorefrost golem",
  noun: "",
  url: "https://gswiki.play.net/Behemothic_gorefrost_golem",
  picture: "",
  # The level of the Behemothic gorefrost golem
  # This indicates the difficulty level of the golem in combat.
  level: 104,
  family: "golem",
  type: "biped",
  undead: false,
  ...
  bcs: true,
  # The maximum hit points of the Behemothic gorefrost golem
  # This value represents the total health the golem can have.
  max_hp: 1000,
  speed: nil,
  # The height of the Behemothic gorefrost golem in inches
  # This indicates how tall the golem is.
  height: 40,
  size: "huge",
  # Contains the attack attributes of the Behemothic gorefrost golem
  # This includes various types of attacks the golem can perform.
  attack_attributes: {
    # List of physical attacks performed by the Behemothic gorefrost golem
    # Each attack has a name and damage range.
    physical_attacks: [
      {
        name: "closed fist",
        as: (480..500)
    ...
    # List of bolt spells used by the Behemothic gorefrost golem
    # Each spell has a name and damage value.
    bolt_spells: [
      {
    ...
    # List of warding spells used by the Behemothic gorefrost golem
    # These spells provide defensive capabilities.
    warding_spells: [
      {
        name: "cold snap (512)",
        cs: 444
    ...
    # List of offensive spells used by the Behemothic gorefrost golem
    # These spells are used to attack opponents.
    offensive_spells: [
      {
        name: "major elemental wave (435)"
      }
    ],
    # List of combat maneuvers available to the Behemothic gorefrost golem
    # These maneuvers enhance its combat effectiveness.
    maneuvers: [
      {
        name: "haymaker"
      },
    ...
    # List of special abilities of the Behemothic gorefrost golem
  ...
  # Contains the defense attributes of the Behemothic gorefrost golem
  # This includes various defensive stats.
  defense_attributes: {
    # The armor class of the Behemothic gorefrost golem
    # This indicates its defensive capabilities against attacks.
    asg: "20N",
    immunities: [],
    melee: 339,
    ranged: 317,
  ...
  abilities: [],
  alchemy: [],
  # Contains the treasure attributes of the Behemothic gorefrost golem
  # This includes the types of loot it can drop.
  treasure: {
    coins: true,
    magic_items: nil,
    gems: true,
  ...
  messaging: {
    ...
    # Advice for wizards facing the Behemothic gorefrost golem
    # This includes strategies and tips for combat.
