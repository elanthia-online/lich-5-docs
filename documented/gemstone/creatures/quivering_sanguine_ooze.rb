# Represents the Quivering Sanguine Ooze
# This data structure contains various attributes of the Quivering Sanguine Ooze, including its name, level, family, and abilities.
# @example Creating a Quivering Sanguine Ooze data structure
#   ooze = {
...
#   }
{
  # The name of the ooze.
  name: "Quivering sanguine ooze",
  noun: "",
  # The URL for more information about the ooze.
  url: "https://gswiki.play.net/Quivering_sanguine_ooze",
  picture: "",
  # The level of the ooze.
  level: 107,
  # The family classification of the ooze.
  family: "Ooze",
  # The type of the ooze.
  type: "Globoid",
  undead: false,
  boss: false,
  otherclass: [],
  ...
  # Indicates if the ooze has a battle control system.
  bcs: true,
  max_hp: nil,
  speed: nil,
  height: nil,
  size: nil,
  # Contains the attack attributes of the ooze.
  attack_attributes: {
    # List of physical attacks the ooze can perform.
    physical_attacks: [
      {
        name: "",
        as: ""
    ...
    # List of bolt spells the ooze can cast.
    bolt_spells: [],
    warding_spells: [],
    offensive_spells: [],
    maneuvers: [],
  ...
  # Contains the defense attributes of the ooze.
  defense_attributes: {
    # The armor class of the ooze.
    asg: nil,
    # List of immunities the ooze possesses.
    immunities: [],
    melee: nil,
    ranged: nil,
    bolt: nil,
  ...
  abilities: [],
  alchemy: [],
  # Contains the treasure attributes of the ooze.
  treasure: {
    # The amount of coins the ooze may drop.
    coins: nil,
    magic_items: nil,
    gems: nil,
    boxes: true,
  ...
  # Contains messaging information related to the ooze.
  messaging: {
