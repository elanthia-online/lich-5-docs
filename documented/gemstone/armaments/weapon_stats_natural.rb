...
=end
        # A collection of weapon stats for natural weapons.
        # Each entry includes various attributes related to the weapon's
        # performance and characteristics.
        #
        # @example Example of a weapon stat entry:
        #   @@weapon_stats_natural[:bite]
        #   # => {:category=>:natural, :base_name=>"bite", ...}
