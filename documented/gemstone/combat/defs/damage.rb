...
module Lich
  ...
  module Gemstone
    # Namespace for combat-related parsing and analysis.
    module Combat
      # Namespace for pattern definitions used by combat modules.
      module Definitions
        # Damage pattern definitions and parsing for attacks, spells, flares, and environmental effects.
        #
        # Provides regex patterns to match damage messages from the game server and a
        # `.parse` method to extract damage amounts and optional targets from a single line.
        #
        # Patterns are organized by source (basic physical attacks, spell effects, environmental
        # damage, and fallback forms) and ordered to prefer specific matches over broad ones.
        #
        # @see .parse
        # @api public
        module Damage
