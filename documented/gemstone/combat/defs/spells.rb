...
#
# Lich provides a scripting interface to the text-based games GemStone IV and
# DragonRealms, allowing script authors to automate gameplay and interact with
# the game server via .lic script files.
module Lich
  # Namespace for GemStone IV game integration.
  module Gemstone
    # Namespace for combat mechanics and attack tracking in GemStone IV.
    module Combat
      # Namespace for combat attack definitions and spell attack pattern catalogs.
      module Definitions
