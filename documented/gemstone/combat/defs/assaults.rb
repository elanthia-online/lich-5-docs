...
module Lich
  # Namespace for GemStone IV game mechanics and protocol handling.
  module Gemstone
    # Namespace for combat-related mechanics: attacks, assaults, sequences, and their patterns.
    module Combat
      # Namespace for pattern definitions used in combat processing.
      module Definitions
