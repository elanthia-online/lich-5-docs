    ...
    module Combat
      ...
      module Tracker
        ...
        class << self
          ...
          # Returns the configured fallback max HP for creatures without templates.
          #
          # @return [Integer] the fallback max HP value
          def fallback_hp
            initialize! unless @initialized
          ...
          # Pattern matching combat resolution outcomes: hit, miss, parry, block, or dodge.
          #
          # Case-insensitive word-boundary match used to detect attack resolution lines
          # in game output when the full COMBAT_RELEVANT_PATTERN is too broad.
          #
          # @example
          #   "You hit the goblin." #=> match
          #   "Your swing misses." #=> match
